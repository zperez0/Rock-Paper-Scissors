...
if player_one_decision == 'rock' && player_two_decision == 'scissors' || player_one_decision == 'scissors' && player_two_decision == 'paper' || player_one_decision == 'paper' && player_two_decision == 'rock'
  @player_one_score = 1
  end
end
end
